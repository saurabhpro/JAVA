...
public class PathsIn {
	public static void main(String[] args) throws URISyntaxException {
		...
		try {
			...
			System.err.println("URI FileSystemNotFoundException not found!");
		}
		...
		try {
			...
			System.err.println("URI ProviderNotFoundException not found!");
		}
		...
		System.out.println(Paths.get("../jungle/.././rain..").toAbsolutePath());
