...
import static collections.MostRepeatedWords.findMostRepeatedWord;

class MostRepeatedWordsTest {
    ...
    void mostRepeatedWord() {
        ...
        Assertions.assertEquals("lorem", findMostRepeatedWord(testString));
        ...
        Assertions.assertEquals("penguins", findMostRepeatedWord(testString2));
        ...
        Assertions.assertEquals("used", findMostRepeatedWord(testString3));
        ...
        String testString4 = "Sunday morning rain is falling\n" +
                ...
                "\n" +
                "Oh, yeah, yeah, oh\n";
        Assertions.assertEquals("morning", findMostRepeatedWord(testString4));
