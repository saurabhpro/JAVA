package Ch07_Object_Oriented_Design.Q7_06_Jigsaw;
...
public class Question {
    ...
    private static LinkedList<Piece> initializePuzzle(int size) {
    ...
    private static String solutionToString(Piece[][] solution) {
        StringBuilder sb = new StringBuilder();
        for (Piece[] aSolution : solution) {
            for (Piece p : aSolution) {
                if (p == null) {
                    sb.append("null");
                } else {
    ...
    private static boolean validate(Piece[][] solution) {
