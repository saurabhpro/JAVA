...
public class QuestionB {
    ...
    private static int findOpenNumber(String filename) throws FileNotFoundException {
    ...
    private static void generateFile(String filename, int max, int missing) throws FileNotFoundException {
