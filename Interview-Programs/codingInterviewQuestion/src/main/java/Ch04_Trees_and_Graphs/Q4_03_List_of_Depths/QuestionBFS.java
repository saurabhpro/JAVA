package Ch04_Trees_and_Graphs.Q4_03_List_of_Depths;
...
public class QuestionBFS {
    ...
    private static void printResult(ArrayList<LinkedList<TreeNode>> result) {
        ...
        for (LinkedList<TreeNode> entry : result) {
			...
			/* TODO
			for (TreeNode anEntry : entry) {
				System.out.print(" " + anEntry.data);
			}
			*/

            entry.stream().map(anEntry -> " " + anEntry.data).forEach(System.out::print);
