package Ch17_Hard.Q17_21_Volume_of_Histogram;

public class QuestionB {
    private static int borderedVolume(HistogramData[] data, int start, int end) {
    ...
    private static int subgraphVolume(HistogramData[] histogram, int start, int end, boolean isLeft) {
        if (start >= end) return 0;
        int sum = 0;
        if (isLeft) {
    ...
    private static HistogramData[] createHistogramData(int[] histo) {
