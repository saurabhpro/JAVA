...
public class QuestionA {
    ...
    private static HashMap<String, NameSet> constructGroups(HashMap<String, Integer> names) {
    ...
    private static void mergeClasses(HashMap<String, NameSet> groups, String[][] synonyms) {
    ...
    private static HashMap<String, Integer> convertToMap(HashMap<String, NameSet> groups) {
