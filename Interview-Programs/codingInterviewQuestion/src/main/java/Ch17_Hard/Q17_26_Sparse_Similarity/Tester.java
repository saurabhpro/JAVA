...
public class Tester {
    ...
    private static boolean isEqual(HashMap<DocPair, Double> one, HashMap<DocPair, Double> two) {
    ...
    private static void addTo(HashMap<Integer, Document> documents, int id, int[] array) {
