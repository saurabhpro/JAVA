...
public class QuestionB {
    ...
    private static HashMapList<Integer, Integer> groupWords(HashMap<Integer, Document> documents) {
    ...
    private static HashMap<DocPair, Double> computeIntersections(HashMapList<Integer, Integer> wordToDocs) {
    ...
    private static void increment(HashMap<DocPair, Double> similarities, int doc1, int doc2) {
    ...
    private static void adjustToSimilarities(HashMap<Integer, Document> documents, HashMap<DocPair, Double> similarities) {
