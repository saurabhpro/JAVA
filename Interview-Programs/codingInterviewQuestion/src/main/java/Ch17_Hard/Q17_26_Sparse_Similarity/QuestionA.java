...
public class QuestionA {
    ...
    private static HashMap<DocPair, Double> computeSimilarities(ArrayList<Document> documents) {
    ...
    private static double computeSimilarity(Document doc1, Document doc2) {
        int intersection = 0;
