package Ch16_Moderate.Q16_10_Living_People;
...
public class QuestionB {
    ...
    private static int[] createYearMap(Person[] people, int min, int max) {
    ...
    private static void incrementRange(int[] values, int left, int right) {
