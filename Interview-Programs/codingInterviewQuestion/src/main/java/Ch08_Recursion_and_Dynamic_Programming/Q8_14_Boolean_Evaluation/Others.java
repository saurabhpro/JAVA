...
public class Others {
    private static String reduce(String expression, int start, int end) {
        if (start == end) {
    ...
    private static boolean evaluate(String expression, int start, int end) {
    ...
    private static String insertParensAround(String expression, int ind) {
        int left = 0;
        int right = 0;
        int index = 0;
        int count = 0;
    ...
    public static void main(String[] args) {
        ...
        bruteForce(terms, new HashMap<>(), result, new boolean[(terms.length() - 1) / 2]);
        System.out.println(countR(terms, result, 0, terms.length() - 1));
        System.out.println(countDP(terms, result, 0, terms.length() - 1, new HashMap<>()));
        System.out.println(countDPEff(terms, result, 0, terms.length() - 1, new HashMap<>()));
