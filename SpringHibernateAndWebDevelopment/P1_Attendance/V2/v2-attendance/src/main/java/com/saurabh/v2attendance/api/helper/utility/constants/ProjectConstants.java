package com.saurabh.v2attendance.api.helper.utility.constants;
...
public final class ProjectConstants {
	...
	public static final String BASE_PATH = System.getProperty("os.name").startsWith("Windows") ? "C:\\Users\\kumars\\IdeaProjects\\NewWeb\\" : "src/main/resources/sample_files/";
	...
	public static String BIOMETRIC_FILE_PATH = BASE_PATH + "may.xls";
	public static String FINANCIAL_FORCE_FILE_PATH = BASE_PATH + "FF Report.xlsx";
	public static String ALL_EMPLOYEE_RECORD_FILE_PATH = BASE_PATH + "Emails.xlsx";
	...
	/*	try {
		...
		return "src/main/resources/mock_data/";
	}
