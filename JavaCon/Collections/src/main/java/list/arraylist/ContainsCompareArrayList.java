...
public class ContainsCompareArrayList {
	...
	private static void compareArrayListOwnClassUsingContains() {
		...
		//  list.add(new java.list.arraylist.deadlock.Emp4(1001));
        ...
        doesn't know what to search for and we have not overridden equals in java.list.arraylist.deadlock.Emp3
        So, contains will run the equals of Object class that compares Reference Id's = False

        in java.list.arraylist.deadlock.Emp4 we have overridden equals so now contains compares int id's not references
         */
	}
