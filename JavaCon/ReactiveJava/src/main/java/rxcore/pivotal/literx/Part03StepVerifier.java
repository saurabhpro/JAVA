...
//========================================================================================
    ...
    void expectSkylerJesseComplete(Flux<User> flux) {
        StepVerifier
            .create(flux)
            .expectNextMatches(user -> user.userName().equals("swhite"))
            .expectNextMatches(user -> user.userName().equals("jpinkman"))
            //.assertNext(user -> Assertions.assertThat(user.userName()).isEqualToIgnoringCase("jpinkman"))
            .verifyComplete();
    }
