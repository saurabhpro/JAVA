...
class B implements AutoCloseable {
	 ...
	 *
	 * @throws Exception if this resource cannot be closed      //a implenter can choose to have or not have throw
	 */
	@Override
	public void close() {
...
public class TryWithResources {
	public static void main(String[] args) throws Exception {
		try (A a = new A()) {
			...
			e.printStackTrace();
		} //catch needed as Close() of A throw Exception

		try (B b = new B()) {
		}   //no catch needed as Close() of B dosent throw Exception
		...
		try (A a = new A(); B b = new B()) {
             ...
             */
			System.out.println("throw of A un-HANDLED so DECLARED main throws Exception, else error");
