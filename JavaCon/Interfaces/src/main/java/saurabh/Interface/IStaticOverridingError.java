...
class StaticInterfaceMethodWorks implements IStaticOverridingTest2 {
    ...
    public static void main(String[] args) {
        ...
        // overloadingTest2.show();
        //  static methods in interfaces are only accessible via Class Names not passed instances
        // since we can't do this - no problem like the polymorphic case
    }
}
