...
public class Tester {
	...
	private static boolean isEqual(LinkedList<Person> path1, LinkedList<Person> path2, boolean reverse) {
	...
	private static boolean isEquivalent(LinkedList<Person> path1, LinkedList<Person> path2) {
