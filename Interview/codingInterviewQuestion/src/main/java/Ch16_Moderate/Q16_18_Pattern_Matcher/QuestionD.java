package Ch16_Moderate.Q16_18_Pattern_Matcher;
...
public class QuestionD {
	...
	private static boolean matches(String pattern, String value, int mainSize, int altSize, int firstAlt) {
	...
	private static boolean isEqual(String s1, int offset1, int offset2, int size) {
