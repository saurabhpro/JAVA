...
public class Question {
	...
	private static boolean isApproxEqual(Point p1, Point p2) {
		return isApproxEqual(p1.x, p2.x) && isApproxEqual(p1.y, p2.y);
	}

	private static boolean doTest(Square s1, Square s2, Point start, Point end) {
		Line line = s1.cut(s2);
	...
	private static boolean doTestFull(Square s1, Square s2, Point start, Point end) {
