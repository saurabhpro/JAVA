...
public class QuestionB {
	...
	private static int parseNextNumber(String seq, int offset) {
	...
	private static void collapseTop(Operator futureTop, Stack<Double> numberStack, Stack<Operator> operatorStack) {
	...
	private static double compute(String sequence) {
