...
public class QuestionB {
	...
	private static LinkedList<String> transform(HashSet<String> visited, String start, String stop, HashMapList<String, String> wildcardToWordList) {
	...
	private static HashMapList<String, String> createWildcardToWordMap(String[] words) {
	...
	private static ArrayList<String> getWildcardRoots(String w) {
