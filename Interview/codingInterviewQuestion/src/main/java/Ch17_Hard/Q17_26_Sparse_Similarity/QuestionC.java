...
public class QuestionC {
	...
	private static ArrayList<Element> sortWords(HashMap<Integer, Document> docs) {
	...
	private static HashMap<DocPair, Double> computeIntersections(ArrayList<Element> elements) {
