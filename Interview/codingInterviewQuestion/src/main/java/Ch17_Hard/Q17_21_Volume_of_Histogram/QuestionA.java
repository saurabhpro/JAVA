...
public class QuestionA {
	...
	private static int findIndexOfMax(int[] histogram, int start, int end) {
	...
	private static int borderedVolume(int[] histogram, int start, int end) {
	...
	private static int subgraphVolume(int[] histogram, int start, int end, boolean isLeft) {
		if (start >= end) return 0;
		int sum = 0;
		if (isLeft) {
