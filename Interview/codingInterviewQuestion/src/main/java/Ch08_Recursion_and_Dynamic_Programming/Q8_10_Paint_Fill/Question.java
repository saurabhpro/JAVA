package Ch08_Recursion_and_Dynamic_Programming.Q8_10_Paint_Fill;
...
public class Question {
	...
	private static void PrintScreen(Color[][] screen) {
		for (Color[] aScreen : screen) {
			for (int c = 0; c < screen[0].length; c++) {
				System.out.print(PrintColor(aScreen[c]));
			}
			System.out.println();
		}
	}
	...
	private static boolean PaintFill(Color[][] screen, int r, int c, Color ncolor) {
		return screen[r][c] != ncolor && PaintFill(screen, r, c, screen[r][c], ncolor);
	}
